...
import type { ActivityItem as ActivityType } from '@/hooks/useActivity'
      ...
      <div className="flex items-center justify-between p-3.5 bg-card border border-divider rounded-card shadow-card select-none">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[12px] text-text-secondary font-medium mt-0.5 leading-none">
              {title}
            </span>
    ...
    return (
      <div className="flex items-center justify-between p-3.5 bg-card/65 border border-divider/60 rounded-card select-none">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-[14px] font-semibold text-text-secondary leading-tight">
              {item.personName}
            </span>
            <span className="text-[12px] text-text-secondary mt-0.5 leading-none">
              {title} ({subtitle})
            </span>
            <span className="text-[11px] text-text-tertiary mt-1">
              {dateStr}
